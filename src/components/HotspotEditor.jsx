  ...
  return (
    <div className="w-72 bg-gray-900 border-l border-gray-800 flex flex-col">
      <div className="p-4 border-b border-gray-800">
        <h2 className="text-lg font-semibold text-white">Точки перехода</h2>
        <p className="text-sm text-gray-500 mt-1">
          Нажмите «Добавить точку» затем кликните на панораму.
        </p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {currentHotspots.length === 0 ? (
          <div className="text-gray-500 text-sm text-center p-4">
            Нет точек перехода.
            <br />
            Добавьте точки для создания навигации.
          </div>
        ) : (
      ...
      <div className="p-3 border-t border-gray-800 text-xs text-gray-500">
        {currentHotspots.length} точек на этой панораме
      </div>
    </div>
  );
}
